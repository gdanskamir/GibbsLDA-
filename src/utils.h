...
public:
    ...
    static void sort_topn(vector<pair<int, double> > & vect, int left, int right, int top_n);

    //get time
    static void get_current_timestr(char* time_str, size_t time_str_buf_len);
    
    static void timer_start(timespec *aStartTime);
    static long timer_end(timespec *aStartTime);
};
